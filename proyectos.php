        ...
        <nav class="navbar navbar-expand-md mb-4">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="d-flex">
                        <a class="btn btn-rojo" type="submit"><i class="fa-solid fa-arrow-down-long"></i>Descargar mi CV
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12 col-sm-4 p-3">
                <div class="proyecto">
                    ...
                    <p class="p-3 pb-3 d-block">Alta, baja y modificación de un registro de clientes. Realizado en HTML,
            ...
            <div class="col-12 col-sm-4 p-3">
                <div class="proyecto">
                    ...
                    <p class="p-3 pb-3 d-block">Sistema de gestión de clientes, productos y ventas. Realizado en HTML,
