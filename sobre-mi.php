        ...
        <nav class="navbar navbar-expand-md mb-4">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="d-flex">
                        <a class="btn btn-rojo"><i class="fa-solid fa-arrow-down-long"></i> Descargar mi CV </a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 col-12 mt-4 offset-sm-2">
                    <img src="images/Sobre mi foto.jpeg" alt="Tomas Miranda" title="Tomas Miranda"
                        class="img-fluid img-circle">
                </div>
            </div>
        </div>
        <section id="stacktech" class="color-gradiente pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-sm-2 col-6 text-center">
                        <div class="px-4 py-5 boxes mx-0 mb-4 mb-sm-0">
                            <h3>Javascript</h3>
                ...
                <div class="col-12 col-sm-6">
                    <div class="row">
                        <div class="col-2 py-3 my-auto d-none d-sm-block">
                            <img src="images/Escuela.png" class="img-fluid baw" title="depcsuite">
                        </div>
                        <div class="col-12- col-sm-10 p-3">
                            <h3 class="formaciont">Secundario Completo</h3>
                            <h4>Escuela EES 64</h4>
                            <h5>2012 – 2018</h5>
                        </div>
                    </div>
                </div>
        ...
        <section id="cursos" class="container">
            ...
            <div class="row shadow bg-white rounded p-1">
                <div class="col-12 col-sm-6">
                    <div class="row">
                        <div class="col-2 py-3 my-auto d-none d-sm-block">
                            <img src="images/dpcsuite.jfif" class="img-fluid baw" title="depcsuite">
                        </div>
                        <div class="col-12- col-sm-10 p-3">
                            <h3 class="formaciont">Desarrollador Full Stack</h3>
                            <h4>DePCSuite</h4>
                            <h5>2022</h5>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="row ml-sm-2 bg-white card-idioma shadow ms-sm-1">
                            ...
                            <div class="col-8 p-5">
                                <h2>HOBBIES</h2>
                                <ul>
                                    <li>Edición audiovisual - Guitarra - Piano</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="container mt-5">
        <div class="row">
            <div class="col-12 col-sm-3">
                ...
                <a href="https://www.linkedin.com/in/tomas-miranda-a87544238/">
                    <i class="fa-brands fa-linkedin-in"></i></a>
            </div>
            <div class="col-12 col-sm-3">Sponsor <a href="http://depcsuite.com">DePc Suite</a></div>
            <div class="col-12 col-sm-3"><a href="mailto:TomasNMiranda15@gmail.com">TomasNMiranda15@gmail.com</a></div>
        </div>
    </footer>
    <div class="whatsapp pt-3 pb-4 px-3">
        <a href="https://api.whatsapp.com/send?phone=5402235628710">
